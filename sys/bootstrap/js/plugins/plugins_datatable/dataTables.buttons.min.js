...
(function(e) {
    ...
    e.extend(l.prototype, {
        ...
        active: function(a, b) {
            ...
            if (b === m) return c.node.hasClass(d);
            c.node.toggleClass(d, b === m ? !0 : b);
            return this
        },
        add: function(a,
            b) {
        ...
        destroy: function() {
            ...
            for (a = a.length; c <
                ...
                this.removePrep(c);
                d = 0;
                for (f = b[c].length; d < f; d++) this.removePrep(c + "-" + d)
            }
            this.removeCommit();
        ...
        removeCommit: function() {
            var a = this.s.buttons,
                b = this.s.subButtons,
                c, d;
            for (c = a.length - 1; 0 <= c; c--) null === a[c] && (a.splice(c, 1), b.splice(c, 1), this.c.buttons.splice(c, 1));
            c = 0;
            for (a = b.length; c < a; c++)
        ...
        _constructor: function() {
            ...
            e("body").on("keyup." + this.s.namespace,
                function(b) {
        ...
        _buildButtons: function(a, b, c) {
            ...
            for (var g = 0, k = a.length; g < k; g++) {
                var h = this._resolveExtends(a[g]);
                if (h)
                    if (e.isArray(h)) this._buildButtons(h, b, c);
                    else {
                        var q =
                            this._buildButton(h, c !== m ? !0 : !1);
                        if (q) {
                            var r = q.node;
                            b.append(q.inserter);
                            ...
                            h.buttons && (q = this.c.dom.collection, h._collection = e("<" + q.tag + "/>").addClass(q.className), this._buildButtons(h.buttons, h._collection, f));
                            h.init && h.init.call(d.button(r), d, r, h);
                            f++
                        }
                    }
            }
        ...
        _buildButton: function(a, b) {
            ...
            var h = e("<" + c.tag + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(b) {
                b.preventDefault();
                !h.hasClass(c.disabled) && a.action && a.action.call(g.button(h), b, g, h, a);
                h.blur()
            }).on("keyup.dtb", function(b) {
                b.keyCode === 13 && !h.hasClass(c.disabled) &&
                    a.action && a.action.call(g.button(h), b, g, h, a)
            });
            d.tag ? h.append(e("<" + d.tag + "/>").html(k(a.text)).addClass(d.className)) : h.html(k(a.text));
            !1 === a.enabled && h.addClass(c.disabled);
            a.className && h.addClass(a.className);
            a.titleAttr && h.attr("title", a.titleAttr);
            a.namespace || (a.namespace = ".dt-button-" + u++);
            d = (d = this.c.dom.buttonContainer) && d.tag ? e("<" + d.tag + "/>").addClass(d.className).append(h) : h;
            this._addKey(a);
            return {
                node: h,
                inserter: d
        ...
        _indexToButton: function(a) {
            if ("number" === typeof a || -1 === a.indexOf("-")) return this.s.buttons[1 *
                a];
            a = a.split("-");
        ...
        _keypress: function(a, b) {
            var c, d, f, g;
            f = this.s.buttons;
            var k = this.s.subButtons,
                h = function(c, d) {
                    if (c.key)
                        if (c.key === a) d.click();
                        else if (e.isPlainObject(c.key) && c.key.key === a && (!c.key.shiftKey || b.shiftKey))
                        if (!c.key.altKey || b.altKey)
                            if (!c.key.ctrlKey || b.ctrlKey)(!c.key.metaKey || b.metaKey) && d.click()
                };
            c = 0;
            for (d = f.length; c < d; c++) h(f[c].conf, f[c].node);
            c = 0;
            for (d = k.length; c < d; c++) {
                f = 0;
                for (g = k[c].length; f < g; f++) h(k[c][f].conf, k[c][f].node)
            }
        },
        _removeKey: function(a) {
            if (a.key) {
                var b =
                    e.isPlainObject(a.key) ? a.key.key : a.key,
        ...
        _resolveExtends: function(a) {
            for (var b = this.s.dt, c, d, f = function(c) {
                ...
                if (k) {
                    a.buttons || (a.buttons = []);
                    c = 0;
                    for (d = k.length; c < d; c++) a.buttons.push(k[c]);
                    a.postfixButtons = null
                }
                if (k = a.prefixButtons) {
                    a.buttons || (a.buttons = []);
                    c = 0;
                    for (d = k.length; c < d; c++) a.buttons.splice(c, 0, k[c]);
    ...
    l.instanceSelector = function(a, b) {
        if (!a) return e.map(b, function(a) {
            return a.inst
        });
        var c = [],
            ...
            f = function(a) {
                if (e.isArray(a))
                    for (var k = 0, h = a.length; k < h; k++) f(a[k]);
        ...
        for (var c = [], d = function(a, b) {
                ...
                if (e.isArray(a) || a instanceof e) {
                    ...
                    if (-1 !== a.indexOf(",")) {
                        var j = a.split(",");
                        f = 0;
                        for (g = j.length; f < g; f++) d(e.trim(j[f]), b)
    ...
    e.extend(j, {
        collection: {
            ...
            action: function(a, b, c, d) {
                var a = c.offset(),
                    ...
                    f = !1;
                e("div.dt-button-background").length && (f = e("div.dt-button-collection").offset(), e(n).trigger("click.dtb-collection"));
                ...
                f && "absolute" === g ? d._collection.css({
                    ...
                    (a = d._collection.height() / 2, a > e(o).height() / 2 && (a = e(o).height() / 2), d._collection.css("marginTop", -1 * a));
                ...
                setTimeout(function() {
                    ...
                    e("body").on("click.dtb-collection", function(a) {
                        if (!e(a.target).parents().andSelf().filter(d._collection).length) {
                            ...
                            e("body").off("click.dtb-collection")
                        }
                    })
                }, 10)
            },
        ...
        excel: function(a, b) {
            ...
            if (j.excelFlash &&
                j.excelFlash.available(a, b)) return "excelFlash"
        },
        pdf: function(a, b) {
            ...
            return {
                ...
                buttons: e.map(b, function(a, b) {
                    return {
                        ...
                        action: function(b, c) {
                            c.page.len(a).draw();
                            e("div.dt-button-background").click()
                        },
                        init: function(b, c, d) {
                            var e = this,
                                c = function() {
    ...
    i.Api.register("buttons.exportData()", function(a) {
        if (this.context.length) {
            for (var b = new i.Api(this.context[0]), c = e.extend(!0, {}, {
                    rows: null,
                    columns: "",
                    modifier: {
                        search: "applied",
                    ...
                    c.decodeEntities && (s.innerHTML = a, a = s.value);
                    return a
                ...
                }).toArray() : null, g = b.rows(c.rows, c.modifier).indexes().toArray(), g = b.cells(g, c.columns).render(c.orthogonal).toArray(), j = a.length, h = 0 < j ? g.length / j : 0, l = Array(h), m = 0, n = 0; n < h; n++) {
                for (var o = Array(j), p = 0; p < j; p++) o[p] = c.format.body(g[m], p, n), m++;
                l[n] = o
            }
            return {
                header: a,
    ...
    e.fn.DataTable.Buttons = l;
    e(n).on("init.dt plugin-init.dt", function(a, b) {
        if ("dt" === a.namespace) {
