...
(function(e) {
    ...
    function y(b) {
        ...
        if (c._select.info && c.aanFeatures.i) {
            var a = e('<span class="select-info"/>'),
                d = function(c, d) {
    ...
    function s(b, c, a, d, f) {
        ...
        "os" === e ? b.ctrlKey || b.metaKey ? c[d](f).select(!k) : b.shiftKey ? "cell" === d ? v(c, f, a._select_lastCell || null) : z(c, d, f, a._select_lastCell ? a._select_lastCell[d] : null) : (b = c[d + "s"]({
                selected: !0
            }), k && 1 === b.flatten().length ? c[d](f).deselect() : (b.deselect(), c[d](f).select())) : "multi+shift" == e ? b.shiftKey ?
    ...
    g.select.init = function(b) {
        ...
        else if (e.isPlainObject(a) && (a.blurable !== h && (m = a.blurable), a.info !== h && (k = a.info), a.items !== h && (d = a.items), a.style !== h && (f = a.style, i = !0), a.selector !== h && (w = a.selector), a.className !== h)) j = a.className;
        b.select.selector(w);
        b.select.items(d);
        b.select.style(f);
        b.select.blurable(m);
